...
# UUID'yi de kaydet
data modify storage glc_menu:names temp.UUID insert 0 from entity @s UUID[0]
data modify storage glc_menu:names temp.UUID insert 1 from entity @s UUID[1]
data modify storage glc_menu:names temp.UUID insert 2 from entity @s UUID[2]
