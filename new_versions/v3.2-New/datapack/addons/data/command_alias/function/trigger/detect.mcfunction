...
# Open to GUI
execute if score @s ca.temp matches 1.. run function command_alias:gui/main_menu

# Open GUI Trigger:
execute if score @s ca.menu matches 1 run function command_alias:gui/main_menu

# Reset trigger
scoreboard players reset @s ca.trigger
scoreboard players reset @s ca.temp
scoreboard players reset @s ca.menu